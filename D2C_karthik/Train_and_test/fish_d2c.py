...
class fish_D2C(D2C_class, ltv_sys_id_class):
	...
	def angle_normalize(self, x):
		'''
		Function to normalize the fish's angle from [0, Inf] to [-np.pi, np.pi]
		'''
...
if __name__=="__main__":
	...
	MODEL_XML = path_to_D2C + "/models/fish_old.xml"
	path_to_policy = path_to_D2C + "/experiments/fish/exp_1/fish_D2C_policy.txt"
	training_cost_data_file = path_to_D2C + "/experiments/fish/exp_1/fish_D2C_training_cost_history.txt"
	path_to_data = path_to_D2C + "/experiments/fish/exp_1/fish_D2C_data.txt"
	path_to_exp = path_to_D2C + "/experiments/fish/exp_1/"

	with open(path_to_data, 'a') as f:

		f.write("D2C training performed for an inverted fish task:\n\n")
	...
	for i in range(1):
		...
		D2C = fish_D2C(state_dimemsion, control_dimension, MODEL_XML, horizon, lr_0, lr_schedule_k, ctrl_state_freq_ratio=ctrl_state_freq_ratio)
