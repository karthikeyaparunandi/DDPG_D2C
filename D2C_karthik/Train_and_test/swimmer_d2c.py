...
from params.swimmer_params import *
import os

class swimmer_D2C(D2C_class, ltv_sys_id_class):
	...
	def angle_normalize(self, x):
		'''
		Function to normalize the swimmer's angle from [0, Inf] to [-np.pi, np.pi]
		'''
...
if __name__=="__main__":
	...
	MODEL_XML = path_to_D2C + "/models/swimmer.xml"
	path_to_policy = path_to_D2C + "/experiments/swimmer/exp_1/swimmer_D2C_policy.txt"
	training_cost_data_file = path_to_D2C + "/experiments/swimmer/exp_1/swimmer_D2C_training_cost_history.txt"
	path_to_data = path_to_D2C + "/experiments/swimmer/exp_1/swimmer_D2C_data.txt"
	path_to_exp = path_to_D2C + "/experiments/swimmer/exp_1/"

	with open(path_to_data, 'a') as f:

		f.write("D2C training performed for an inverted swimmer task:\n\n")
	...
	goal_state = np.array([0.5, -0.6, 0, 0, 0, 0, 0, 0, 0 ,0])
	...
	for i in range(1):
		...
		D2C = swimmer_D2C(state_dimemsion, control_dimension, MODEL_XML, horizon, lr_0, lr_schedule_k, ctrl_state_freq_ratio=ctrl_state_freq_ratio)
