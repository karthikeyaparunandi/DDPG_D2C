...
class pendulum_D2C(D2C_class, ltv_sys_id_class):
...
if __name__=="__main__":
	...
	MODEL_XML = path_to_D2C + "/models/pendulum.xml"
	path_to_policy = path_to_D2C + "/experiments/pendulum/exp_1/pendulum_D2C_policy.txt"
	training_cost_data_file = path_to_D2C + "/experiments/pendulum/exp_1/pendulum_D2C_training_cost_history.txt"
	path_to_data = path_to_D2C + "/experiments/pendulum/exp_1/pendulum_D2C_data.txt"
	path_to_exp = path_to_D2C + "/experiments/pendulum/exp_1/"
	...
	lr_0 =  0.0008
	lr_schedule_k = 1
	cost_gradient_conv_threshold_percent = 8
	control_conv_threshold_percent = .5
	...
	for i in range(1):
		...
		D2C = pendulum_D2C(state_dimemsion, control_dimension, MODEL_XML, horizon, lr_0, lr_schedule_k, ctrl_state_freq_ratio=ctrl_state_freq_ratio)
