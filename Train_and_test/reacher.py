...
def build_callbacks(env_name):
    ...
    log_filename = 'results/Reacher/exp_1/ddpg_{}_log.json'.format(env_name)
...
# Ctrl + C.
agent.fit(env, nb_steps=1600000, visualize=True, callbacks=callbacks, verbose=1, gamma=GAMMA, nb_max_episode_steps=1600)

# After training is done, we save the final weights.
#agent.save_weights('results/Swimmer/exp_8/ddpg_{}_weights.h5f'.format(ENV_NAME), overwrite=True)
