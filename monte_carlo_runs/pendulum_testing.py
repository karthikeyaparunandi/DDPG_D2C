...
from  pendulum import env, GAMMA, STEPS_PER_EPISODE
...
path_to_save = "../results/Pendulum/exp_8/data.txt"
...
for i in frange(0.0, 1.02, 0.02):
    ...
    for j in range(n_samples):
        ...
        history, state_history, episode_reward = agent.test(env, nb_episodes=1, visualize=False, action_repetition=1, nb_max_episode_steps=STEPS_PER_EPISODE, initial_state=[np.pi, 0], std_dev_noise=i*u_max, gamma=GAMMA)
