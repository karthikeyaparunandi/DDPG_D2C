...
OS = zeros(NUM_SYS, NUM_SYS, STEP_MAX);
TK = zeros(NUM_IN, NUM_SYS, STEP_MAX);
OS(:, :, STEP_MAX) = sig_f * eye(NUM_SYS);
%% Load from .txt file
fid = fopen('lnrcp001sp001.txt','r');
Ua  = fscanf(fid, '%f %f %f');
fclose(fid);
