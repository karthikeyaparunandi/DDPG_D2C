...
agent.load_weights('results/Swimmer6/exp_1/ddpg_{}_weights.h5f'.format(ENV_NAME))
...
u_max = 20
#print(episode_reward_nominal,  state_history_nominal[1500], state_history_nominal)
'''
...
for i in frange(0.0, 1.05, 0.05):
    ...
    for j in range(n_samples):
        ...
        terminal_mse += np.linalg.norm(state_history[1500][0:2] - np.array([0.6, -0.6]), axis=0)
        Var_terminal_mse += (np.linalg.norm(state_history[1500][0:2] - np.array([0.6, -0.6]), axis=0))**2
