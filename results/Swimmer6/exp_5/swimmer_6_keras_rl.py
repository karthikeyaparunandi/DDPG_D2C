...
agent.save_weights('results/Swimmer6/exp_5/ddpg_{}_weights.h5f'.format(ENV_NAME), overwrite=True)
#agent.load_weights('results/Swimmer6/exp_5/ddpg_{}_weights.h5f'.format(ENV_NAME))

# Finally, evaluate our algorithm for 5 episodes.
history, state_history_nominal, episode_reward_nominal = agent.test(env, nb_episodes=1, visualize=True, action_repetition=1, callbacks=test_callbacks, nb_max_episode_steps=1500, \
