...
def build_callbacks(env_name):
    ...
    log_filename = 'results/InvertedPendulum/exp_5/ddpg_{}_log.json'.format(env_name)
...
random_process = OrnsteinUhlenbeckProcess(size=nb_actions, theta=.15, dt=0.1, mu=0., sigma=.27)
...
#agent.save_weights('results/InvertedPendulum/exp_5/ddpg_{}_weights.h5f'.format(ENV_NAME), overwrite=True)
