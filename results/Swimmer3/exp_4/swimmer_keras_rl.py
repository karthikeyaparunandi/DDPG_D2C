...
def build_callbacks(env_name):
    ...
    log_filename = 'results/Swimmer/exp_4/ddpg_{}_log.json'.format(env_name)
...
# Ctrl + C.
#agent.fit(env, nb_steps=800000, visualize=False, callbacks=callbacks, verbose=1, gamma=GAMMA, nb_max_episode_steps=800)

# After training is done, we save the final weights.
#agent.save_weights('results/Swimmer/exp_4/ddpg_{}_weights.h5f'.format(ENV_NAME), overwrite=True)
