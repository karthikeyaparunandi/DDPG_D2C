...
def build_callbacks(env_name):
    ...
    log_filename = 'results/Swimmer/exp_1/ddpg_{}_log.json'.format(env_name)
...
#agent.save_weights('results/Swimmer/exp_1/ddpg_{}_weights.h5f'.format(ENV_NAME), overwrite=True)
agent.load_weights('results/Swimmer/exp_1/ddpg_{}_weights.h5f'.format(ENV_NAME))
