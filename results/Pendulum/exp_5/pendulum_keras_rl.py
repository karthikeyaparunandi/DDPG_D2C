...
#agent.save_weights('results/Pendulum/exp_5/ddpg_{}_weights.h5f'.format(ENV_NAME), overwrite=True)
agent.load_weights('results/Pendulum/exp_5/ddpg_{}_weights.h5f'.format(ENV_NAME))
...
'''
f = open("results/Pendulum/exp_4/data.txt", "a")
...
'''
'''
i, x, y = np.loadtxt('results/Pendulum/exp_4/data.txt', dtype=np.float64, delimiter=',\t',  unpack=True, usecols=(0,1,2))
i = 100*i
plt.figure(1)
plt.plot(i,x)
...
plt.plot(i,y/-1114.0265338715155)
plt.show()
'''
